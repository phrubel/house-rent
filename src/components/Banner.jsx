  ...
  return (
    <section className="h-full max-h-[600px] mb-8 xl:mb-24">
      <div className="flex flex-col lg:flex-row">
        <div data-aos="fade-up-right" className="lg:ml-4 xl:ml-[135px] flex flex-col items-center lg:items-start text-center lg:text-left justify-content flex-1 px-4 lg:px-0">
        ...
        <div data-aos="fade-up-left" className="hidden flex-1 lg:flex justify-end items-end ">
          <img src={banner} alt="" />
        </div>
      </div>
      <Search />
